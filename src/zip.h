...
struct _central_directory_file_header {
    ...
    char     *file_name;                /* file name                       */
    char     *extra_field;              /* extra field                     */
    char     *file_comment;             /* file comment                    */
} __attribute__((packed));

typedef struct _end_of_central_directory_record end_of_central_directory_record;
struct _end_of_central_directory_record {
    ...
    uint8_t  *file_comment;              /* .ZIP file comment                                                             */
} __attribute__((packed));
